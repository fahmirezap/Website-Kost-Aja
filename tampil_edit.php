...
<html lang="en">
  ...
  <div class="jumbotron">
    <div class="container">
        <h1><center>EDIT DATA KOST</center></h1><br>
      </div>
  </div>
    ...
    <form method="POST" ACTION="edit_logic.php">
     ...
     ?>
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="nama_kost" placeholder="<?php echo $data['nama_kost'];?>" required="true">
      </div>
      <div class="form-group">
        <label >JENIS KOST</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['jenis_kost'];?>" name="jenis_kost" required="true">
      </div>
      <div class="form-group">
        <label >JUMLAH KOST</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['jumlah_kost'];?>" name="jumlah_kost" required="true">
      </div>
      <div class="form-group">
        <label >STATUS</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['status'];?>" name="status" required="true">
      </div>
      <div class="form-group">
        <label >DESKRIPSI</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['deskripsi'];?>" name="deskripsi"required="true">
      </div>
      <div class="form-group">
        <label >HARGA KOST</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['harga_kost'];?>" name="harga_kost"required="true">
      </div>
      <div class="form-group">
        <label >LOKASI</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['lokasi'];?>" name="lokasi"required="true">
      </div>
      <div class="form-group">
        <label >KOTA</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['kota'];?>" name="kota" required="true">
      </div>
      <div class="form-group">
        <label >KAMPUS</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['kampus'];?>" name="kampus"required="true">
      </div>
      <div class="form-group">
        <label >FOTO</label>
        <input type="text" class="form-control" placeholder="<?php echo $data['foto'];?>" name="foto" required="true">
      </div>
