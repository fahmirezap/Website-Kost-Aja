...
<html lang="en">
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <p><a href="tampilkos_putra.php"><button class="btn btn-outline-success">Lihat Daftar Kost</button></a></p>
    </div>
    <div class="col-sm-6"> <h2>Kost Putri</h2>
          <p>Berisi Daftar Kost Perempuan</p>
      <p><a href="tampilkos_putri.php"><button class="btn btn-outline-success">Lihat Daftar Kost</button></a></p>
    </div>
  </div>
